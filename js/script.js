...
const videos = [
    ...
    {
        "src": "./video/2.mp4",
        "desc": "Это место, где природа живёт своей жизнью, чаще не затронутой человеком. Здесь царит гармония и покой, и каждый звук, каждый шорох является частью этого удивительного мира. ",
        "title": "Природные симфонии: Вдохновляющие пейзажи и звуки дикой природы"
    },
    {
        "src": "./video/3.mp4",
        "desc": "Как шикарно струится река, как красиво играет солнышко в лазурной воде.",
        "title": "Беречь природы дар бесценный"
    },

    {
        "src": "./video/4.mp4",
        "desc": " Этот удивительный феномен природы создаёт прекрасное зрелище света в ночном небе.",
        "title": "Всё приходящее, а природа вечна…"
    },

    {
        "src": "./video/6.mp4",
        "desc": "Путешествие сквозь времена и пространства, позволяющее увидеть эволюцию природы и ее великолепие, открывая новые грани красоты и гармонии.",
        "title": "Дикие и домашние — все такие важные"
    },
    {
        "src": "./video/8.mp4",
        "desc": "Погружение в удивительный мир дикой природы, где величественные горы встречаются с бескрайними лесами, создавая потрясающие пейзажи и уникальные моменты спокойствия.",
        "title": "Как всё взаимосвязано в природе…"
    },
    {
        "src": "./video/10.mp4",
        "desc": "Подарите себе уникальный опыт наблюдения за закатами над океаном, плавным течением рек и таинственными лесными тропами, вдохновляющими на новые открытия.",
        "title": "Продли их долгий век…"
    },

    {
        "src": "./video/11.mp4",
        "desc": "Исследуйте мир растений, расцветающих в ярких красках и создающих потрясающие пейзажи, напоминающие о величии и красоте природы.",
        "title": "Цветов красою сердце взято в плен"
    },

    {
        "src": "./video/12.mp4",
        "desc": "Путешествие сквозь времена и пространства, позволяющее увидеть эволюцию природы и ее великолепие, открывая новые грани красоты и гармонии.",
        "title": "Маленькие чудеса в большой природе"
    },
    {
        "src": "./video/13.mp4",
        "desc": "Подарите себе уникальный опыт наблюдения за закатами над океаном, плавным течением рек и таинственными лесными тропами, вдохновляющими на новые открытия.",
        "title": "Берегите эту землю"
    },

    {
        "src": "./video/14.mp4",
        "desc": "Исследуйте мир растений, расцветающих в ярких красках и создающих потрясающие пейзажи, напоминающие о величии и красоте природы.",
        "title": "Любить, ценить и охранять"
    },
